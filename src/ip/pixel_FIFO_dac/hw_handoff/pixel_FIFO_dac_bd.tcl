...
################################################################
# This is a generated script based on design: pixel_FIFO_dac
#
...
# source pixel_FIFO_dac_script.tcl
...
set design_name pixel_FIFO_dac
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./Documents/vgacentrifuge2022/fpga/src/ip
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Full_Threshold_Assert_Value {1003} \
   CONFIG.Full_Threshold_Negate_Value {1002} \
   CONFIG.Input_Data_Width {36} \
   CONFIG.Output_Data_Width {36} \
   CONFIG.Performance_Options {First_Word_Fall_Through} \
   CONFIG.Read_Clock_Frequency {25} \
