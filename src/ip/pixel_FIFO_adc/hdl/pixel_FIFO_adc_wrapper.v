...
//Date        : Thu Nov  3 12:40:27 2022
//Host        : dmpro-Aspire-A515-41G running 64-bit Linux Mint 20.1
//Command     : generate_target pixel_FIFO_adc_wrapper.bd
//Design      : pixel_FIFO_adc_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module pixel_FIFO_adc_wrapper
   (FIFO_READ_0_empty,
    FIFO_READ_0_rd_data,
    FIFO_READ_0_rd_en,
    FIFO_WRITE_0_full,
  ...
  output [35:0]FIFO_READ_0_rd_data;
  input FIFO_READ_0_rd_en;
  output FIFO_WRITE_0_full;
  input [35:0]FIFO_WRITE_0_wr_data;
  ...
  wire [35:0]FIFO_READ_0_rd_data;
  wire FIFO_READ_0_rd_en;
  wire FIFO_WRITE_0_full;
  wire [35:0]FIFO_WRITE_0_wr_data;
  wire FIFO_WRITE_0_wr_en;
  wire rd_clk_0;
  wire rst_0;
  wire wr_clk_0;

  pixel_FIFO_adc pixel_FIFO_adc_i
