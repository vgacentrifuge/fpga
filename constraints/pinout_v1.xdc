...
create_interface adc_tvp7002_0
set_property INTERFACE adc_tvp7002_0 [get_ports { colour_bus_0[0] colour_bus_0[1] colour_bus_0[2] colour_bus_0[3] colour_bus_0[4] colour_bus_0[5] colour_bus_0[6] colour_bus_0[7] colour_bus_0[8] colour_bus_0[9] colour_bus_0[10] colour_bus_0[11] colour_bus_0[12] colour_bus_0[13] colour_bus_0[14] colour_bus_0[15] dataclkin_0 vsin_0 hsin_0 fidin_0 }]
set_property -dict { PACKAGE_PIN A2 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[0]}]
set_property -dict { PACKAGE_PIN B2 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[1]}]
set_property -dict { PACKAGE_PIN B1 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[2]}]
set_property -dict { PACKAGE_PIN C2 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[3]}]
set_property -dict { PACKAGE_PIN C1 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[4]}]
set_property -dict { PACKAGE_PIN D3 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[5]}]
set_property -dict { PACKAGE_PIN E3 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[6]}]
set_property -dict { PACKAGE_PIN B4 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[7]}]
set_property -dict { PACKAGE_PIN A4 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[8]}]
set_property -dict { PACKAGE_PIN A3 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[9]}]
set_property -dict { PACKAGE_PIN C3 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[10]}]
set_property -dict { PACKAGE_PIN B7 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[11]}]
set_property -dict { PACKAGE_PIN A7 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[12]}]
set_property -dict { PACKAGE_PIN B6 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[13]}]
set_property -dict { PACKAGE_PIN B5 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[14]}]
set_property -dict { PACKAGE_PIN A5 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports {colour_bus_0[15]}]
set_property -dict { PACKAGE_PIN E5 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports dataclkin_0]
set_property -dict { PACKAGE_PIN E2 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports vsin_0]
set_property -dict { PACKAGE_PIN D1 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports hsin_0]
set_property -dict { PACKAGE_PIN E1 IOSTANDARD LVCMOS33 DIRECTION IN } [get_ports fidin_0]

create_interface adc_tvp7002_1
set_property INTERFACE adc_tvp7002_1 [get_ports { colour_bus_1[0] colour_bus_1[1] colour_bus_1[2] colour_bus_1[3] colour_bus_1[4] colour_bus_1[5] colour_bus_1[6] colour_bus_1[7] colour_bus_1[8] colour_bus_1[9] colour_bus_1[10] colour_bus_1[11] colour_bus_1[12] colour_bus_1[13] colour_bus_1[14] colour_bus_1[15] dataclkin_1 vsin_1 hsin_1 fidin_1 }]
